	...
	ILayerZeroUserApplicationConfig
{
	...
	{
		return
			_interfaceId == type(ILayerZeroBase).interfaceId ||
			_interfaceId == type(ILayerZeroReceiver).interfaceId ||
			_interfaceId == type(ILayerZeroUserApplicationConfig).interfaceId ||
